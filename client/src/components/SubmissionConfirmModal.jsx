  ...
  return (
    ...
    >
      <div className="modal-dialog modal-dialog-centered" style={{ maxWidth: 460 }}>
        <div
          className="modal-content text-light border border-warning"
          style={{ background: 'linear-gradient(135deg, #1f1b0a 0%, #0d0d0d 100%)', boxShadow: '0 0 30px rgba(255,193,7,0.3)' }}
        >
          <div className="modal-header border-secondary px-4 pt-3 pb-2">
          ...
          <div className="modal-body px-4 py-3">
            ...
            <div className="p-3 rounded-3 bg-black border border-secondary mb-3">
              ...
              <input
                type="text"
                className="form-control bg-secondary text-light border-0 font-monospace text-center fs-5 fw-extrabold letter-spacing-2"
                placeholder="END"
                value={confirmText}
          ...
          <div className="modal-footer border-secondary px-4 py-3 d-flex justify-content-between">
            <button
              type="button"
