  ...
  return (
    <div className="modal fade show d-block" tabIndex="-1" style={{ backgroundColor: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(6px)' }}>
      <div className="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div className="modal-content text-body border-danger shadow-lg" style={{ backgroundColor: 'var(--bg-card)' }}>
          {/* Header */}
          ...
          <div className="modal-body p-4">
            {loading ? (
              <div className="text-center py-5">
                ...
                <h6 className="text-body fw-bold">Comparing Candidate Code Submissions...</h6>
              ...
              <div className="d-flex flex-column gap-4">
                ...
                <div className="row g-3">
                  <div className="col-md-3">
                    <div className="p-3 rounded border text-center" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                      <span className="text-muted small d-block">Submissions Scanned</span>
                      <span className="fs-4 fw-bold text-body">{report.totalSubmissionsScanned}</span>
                    </div>
                  </div>
                  <div className="col-md-3">
                    <div className="p-3 rounded border text-center" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                ...
                <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
                  <h6 className="text-body fw-bold m-0 d-flex align-items-center gap-2">
                ...
                {filteredPairs.length === 0 ? (
                  <div className="p-4 rounded text-center text-muted border" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                    No suspicious code matches found matching filter.
                  </div>
                ) : (
                  <div className="table-responsive rounded border" style={{ maxHeight: '280px', overflowY: 'auto' }}>
                      ...
                      <tbody>
                        {filteredPairs.map((pair) => (
                          <tr key={pair.pairId} className={pair.riskLevel === 'High' ? 'table-danger bg-opacity-10' : ''}>
                            <td className="fw-semibold text-body">{pair.problemTitle}</td>
                            <td>
                ...
                {selectedPair && (
                  <div className="p-3 rounded border-info" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                    ...
                    <div className="row g-3">
                      <div className="col-12 col-md-6">
                        <div className="p-2 rounded border bg-body-tertiary">
                          ...
                          <pre className="p-2 bg-body-tertiary text-body font-monospace small mb-0 rounded" style={{ maxHeight: '180px', overflowY: 'auto' }}>
